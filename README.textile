...
Le fork permet de rendre ce plugin compatible avec Redmine 5.x et modifie son fonctionnement pour l'université ...
...
* @style@: the style of the iframe (e.g. "width:100%;height:80vh", "width:500px;height:600px"), default="width:640px;height:480px".
